...
return;
  ...
  return (
    <Wrapper className='page-reset-password'>
      <div className='content-page-reset-password'>
        {alert.show && (
          ...
          >
            ...
            <div id='password-div-visiblity'>
              <FormRow
                ...
                />
                <button type='button' className='visiblity-pass' onClick={togglePasswordVisibility}>
