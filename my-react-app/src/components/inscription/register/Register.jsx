            ...
            <div className='content-main-content-register'>
                <div className='login-part-content-register'>
                    <div className='content-login-part-content-register'>
                        <h1>{t('bonjour_amis')}</h1>
                        <p>{t('non_compte')}</p>
                        <Link to={'/sign_in'}>
                            <button>{t('se_connecter')}</button>
                        </Link>
                    </div>
                </div>
                <div className='signup-content-register'>
                    <div className='content-signup-content-register'>
                        <div className='header-content-register'>
                            <h1>{t('creer_un_compte')}</h1>
                            <p>{t('vos_information')}</p>
                        </div>
                        <div className='form-content-register'>
                            <Form onSubmit={handleSubmit} encType='multipart/form-data' method='post' className='form-form_form-content-register'>
                                <div id='form-two-register-inputs'>
                                    <FormRow type="text" placeholder={t('nom')} name='name' value="" />
                                    <FormRow type="text" placeholder={t('prenom')} name='firstName' value="" />
                                    {/* <FormRow type="text" placeholder="surname" value="" /> */}
                                </div>
                                <div id='form-two-register-inputs'>
                                    <FormRow type="text" placeholder={t('ville')} name='city' value="" />
                                    <FormRow type="text" placeholder={t('pays')} name='country' value="" />
                                </div>
                                <FormRow type="text" placeholder={t('niveau_etude')} name='levelOfStudy' value="" /><br/>
                                <FormRow type="text" placeholder={t('specialite')} name='specialty' value="" /><br/>
                                <FormRow type="text" placeholder={t('profession')} name='occupation' value="" /><br/>
                                <FormRow type="email" placeholder={t('email')} name="email" value="" /><br/>
                                <FormRow type="number" placeholder={t('numero_telephone')} name="numberPhone" value="" /><br/>
                                <div id='signup-visible-password'>
                                    <FormRow type={passwordVisible? 'text': 'password'} placeholder={t('mot_pass')} name="password" value="" id='password-visible-signup' />
                                    <span type='button' className='eye-visibility-pwd-signup' onClick={togglePasswordVisibility}>
                                        {passwordVisible? <FaEyeSlash/> : <FaEye/>}
                                    </span>
                                </div>
                                <div id='signup-visible-password'>
                                    <FormRow type={passwordVisible? 'text': 'password'} placeholder={t('repetez_mot_pass')} name='secondPassword' value="" id='password-visible-signup'/>
                                    <span type='button' className='eye-visibility-pwd-signup' onClick={togglePasswordVisibility}>
                                        {passwordVisible? <FaEyeSlash/> : <FaEye/>}
                                    </span>
                                </div>
                                        ...
                                        <div className="same-card-register-content">
                                            <label className="label-card-nat-register" htmlFor="card-nat-recto">
                                                ...
                                                {profilePicSrc ? (
                                                    ...
                                                    <IoMdImages />
                                                    <p id="color-p-register">{t('carte_identite')}<br/>{t('recto')}</p>
                                                    </div>
                                                )}
                                                </div>
                                            </label>
                                        ...
                                        <div className="same-card-register-content">
                                            <label className="label-card-nat-register" htmlFor="card-nat-verso">
                                                ...
                                                {profilePicTwoSrc ? (
                                                    ...
                                                    <div className="img-added-register-write">
                                                    <IoMdImages />
                                                    <p id="color-p-register">{t('carte_identite')}<br/>{t('verso')}</p>
                                                    </div>
                                                )}
                                                </div>
                                            </label>
                                ...
                                <button type='submit'disabled={isSubmitting}>{isSubmitting?'Soumettre':t('inscrire')}</button>
                            </Form>
                            <Link to={'/'}>
