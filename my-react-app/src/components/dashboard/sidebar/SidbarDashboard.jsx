            ...
            <div className='content-sidebare'>
                ...
                <ul className='ulContainer'>
                    ...
                    <li className={((location.pathname === '/inscription') || (location.pathname === '/inscription/all_users')) ? 'clickedli' : 'liContainer'}>
                        ...
                        <NavLink to={'/inscription/all_users'} className={((location.pathname === '/inscription') || (location.pathname === '/inscription/all_users')) ? 'clickedLink' : 'ItemsNames'}>Inscriptions</NavLink>
                    </li>
                ...
                <div className='return-admin-link-container'>
                    <Link to={'/'}>
                        <li  className={location.pathname === '/' ? 'clickedli' : 'liContainer'}>
                            <div className='navlink-return-to-root-client-side'>
                                <span className='icon-return'><IoIosReturnLeft/></span>
